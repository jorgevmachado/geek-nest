      ...
      providers: [
        {
          ...
          useValue: {
            ...
            update: jest.fn().mockResolvedValueOnce(updateResponse),
            findAll: jest.fn().mockResolvedValueOnce(findALLResponse),
            findOne: jest.fn().mockResolvedValueOnce(findOneResponse),
            promote: jest.fn().mockResolvedValueOnce(promoteResponse),
          },
        },
      ],
    }).compile();
